...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [BASE] = LAYOUT_60_hhkb( //  default layer
    ...
    /* [BASE] = LAYOUT( //  default layer */
        /* KC_GESC, KC_2, KC_2, KC_3, KC_4, KC_5, KC_6, KC_7, KC_8, KC_9, KC_0, KC_MINS, KC_EQL, KC_BSLS, KC_GRV, */
        /* KC_TAB, KC_Q, KC_W, KC_E, KC_R, KC_T, KC_Y, KC_U, KC_I, KC_O, KC_P, KC_LBRC, KC_RBRC, KC_BSPC, */
        /* KC_LCTL, KC_A, KC_S, KC_D, KC_F, KC_G, KC_H, KC_J, KC_K, KC_L, KC_SCLN, KC_QUOT, KC_ENT, */
        /* KC_LSFT, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_RSFT, MO(HHKB), */
        /* KC_LALT, KC_LGUI, [>        <] KC_SPC, KC_RGUI, KC_RALT), */
    ...
    /* Layer HHKB: HHKB mode (HHKB Fn)
      ...
      |------+-----+-----+-----+-----+----+----+----+-----+-----+-----+-----+-------+-------+-----|
      |      |     | VoD | Mut | VoU |    | *  | /  | Hom | PgU | Lef | Rig | Enter |       |     |
      |------+-----+-----+-----+-----+----+----+----+-----+-----+-----+-----+-------+-------+-----|
      |      |     |     |     |     |    | +  | -  | End | PgD | Dow |     |       |       |     |
      |------+-----+-----+-----+-----+----+----+----+-----+-----+-----+-----+-------+-------+-----|
	...
	[HHKB] = LAYOUT_60_hhkb(
			...
			KC_TRNS    , KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_PPLS, KC_PMNS, KC_BRID , KC_PGDN, KC_DOWN,  KC_TRNS      , KC_TRNS ,
