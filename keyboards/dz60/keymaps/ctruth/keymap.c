...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [VIM] = LAYOUT(
        ...
        KC_TAB , _______, DEL_W  , _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
    ...
    [MOUS] = LAYOUT(
        ...
        _______, _______, KC_BTN1, KC_MS_U, KC_BTN2, _______, _______, KC_BTN1, KC_MS_U, KC_BTN2, _______, _______, _______, _______,
